  ...
  <div class="flex flex-col min-h-screen font-sans leading-normal content-wrapper bg-background-primary text-copy-primary" :class="theme">
    <header class="border-t-14 border-nord-10">
      <nav class="container flex flex-wrap items-center justify-between py-8 mx-auto">
        ...
        <ul
          class="items-center flex-grow block w-full mt-8 font-bold tracking-wide uppercase lg:space-x-8 space-y-6 lg:space-y-0 lg:flex lg:flex-initial lg:w-auto lg:mt-0"
    ...
    <footer class="text-white bg-nord-1">
      <div class="container flex flex-col items-center justify-between py-8 mx-auto lg:flex-row">
        ...
        <ul class="flex items-center space-x-8">
          ...
          <li>
            <a href="https://github.com/EduardoOrtiz89" target="_blank" class="text-white hover:text-gray-400">
